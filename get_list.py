...
def fetch_list(subject,faculty,path):
	...
	try:
		...
		data = ('display_mode_in=LIST&search_mode_in=&term_in=201209&sel_subj=dummy&sel_day=dummy&sel_schd=dummy&sel_insm=dummy&sel_camp=dummy' +
		...
		gpaStuff = opener.open('https://banweb.mcgill.ca/pban1/bwckschd.p_get_crse_unsec', data)
